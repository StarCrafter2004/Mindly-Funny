...
export interface ApiCelebrityCelebrity extends Struct.SingleTypeSchema {
...
export interface ApiCountryCountry extends Struct.SingleTypeSchema {
...
export interface ApiCustomLocaleCustomLocale
  extends Struct.CollectionTypeSchema {
  collectionName: 'custom_locales';
  info: {
    displayName: 'CustomLocale';
    pluralName: 'custom-locales';
    singularName: 'custom-locale';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    AppTranslation: Schema.Attribute.JSON;
    code: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-locale.custom-locale'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGiftConfigGiftConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'GiftConfig';
    pluralName: 'gift-configs';
    singularName: 'gift-config';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    extra: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    payload: Schema.Attribute.String & Schema.Attribute.Required;
    payment_status: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    telegramChargeId: Schema.Attribute.String;
...
export interface ApiProfessionProfession extends Struct.SingleTypeSchema {
...
export interface ApiReferralReferral extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    referrer_id: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTUserTUser extends Struct.CollectionTypeSchema {
...
export interface ApiTestResultTestResult extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    testId: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    timeLimit: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiTonConfigTonConfig extends Struct.SingleTypeSchema {
  collectionName: 'ton_configs';
  info: {
    displayName: 'TonConfig';
    pluralName: 'ton-configs';
    singularName: 'ton-config';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::t-user.t-user': ApiTUserTUser;
      'api::test-result.test-result': ApiTestResultTestResult;
      'api::test.test': ApiTestTest;
      'api::ton-config.ton-config': ApiTonConfigTonConfig;
